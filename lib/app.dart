...
import 'package:mobile/pagina_premium.dart';
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const Mural()),
                      );
                    },
                  ),
                  ListTile(
                  ...
                  ListTile(
                    leading: const Icon(Icons.vertical_align_bottom_sharp),
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const PaginaProvasEnem(),
                        ),
                      );
                    },                   
                  ),
...
ListTile(
  leading: const Icon(Icons.edit_note), // Ícone de correção
  title: const Text('Corrigir Simulados'),
  onTap: () {
            ...
            const Divider(),
             ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const PaginaPremium()),
                );
              },
            ),
            ListTile(
