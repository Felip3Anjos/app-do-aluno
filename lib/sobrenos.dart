...
class _MembroCardState extends State<_MembroCard> {
    ...
    return Center(
      child: MouseRegion(
        ...
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 300), //300milisegundos até abrir completamente
  ...
  children: [
    ...
    const SizedBox(height: 10), // espaço entre a foto e o nome
    Text(
    ...
    AnimatedCrossFade( // animação para mostrar ou esconder o texto
      ...
      firstChild: Padding( // conteúdo visível quando hover = true (passa o raí do mouse)
        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10), // espaço interno
        child: Text(
      ...
      secondChild: const SizedBox(height: 0), // conteúdo vazio quando hover = false
    ),
