    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ElevatedButton(
            onPressed: () {
              _salvarEvento(dataSelecionada, _controller.text);
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: _isLoading
                ? Center(child: CircularProgressIndicator(color: isDark ? Colors.white : Color.fromARGB(255, 0, 52, 80)))
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: isDark ? Color(0xFF335D9B) : Color.fromARGB(255, 241, 117, 34),
                              ...
                              if (dayIndex < firstWeekdayOfMonth || dayNum > daysInMonth) {
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: isDark ? Color(0xFF2C2C3C) : Colors.grey[200],
